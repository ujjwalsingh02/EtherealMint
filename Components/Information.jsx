        ...
        <div class=" row">
          <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="section-headline text-center">
              <div class="top-text-title">EtherealMint INFORMATION</div>
              <h2>
                EtherealMint token supply and{" "}
                ...
                <table class="table table-borderless text-white tableInfo">
                  <thead>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>0.0000005 BNB ,estimate ( $0.0019 / USR )</td>
                    </tr>
                    <tr>
                      <td>Lock</td>
                      <td>:</td>
